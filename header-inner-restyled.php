    ...
    <div class="top-header__desctop position-relative d-lg-block d-none pt-2">
        <div class="top-header__container container">
            <div class="row  justify-content-between">
                ...
                <div class="telephone-button d-flex justify-content-center  p-0">
                    <a data-fancybox="" data-src="#order-popup" class="wrapper-button d-flex align-items-center rounded-pill px-3 border-aqua">
                ...
                <div class="menu-mobile"><?
                    ...
                    <div class="menu-mobile__phone-btn text-center">
                        <a class="d-inline-block" href="tel:+7 (495) 032-80-45">
                            ...
                            <a class="d-block color-gray mt-3" href="tel:+7 (495) 032-80-45">Заказать обратный звонок</a>
                        </a>
                    </div>
