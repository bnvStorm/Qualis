        ...
        <?php if (have_posts()) : ?>
            <?php while (have_posts()) : the_post(); ?>
                <div class="single-article row">
                    ...
                    <? } ?>
                    <div class="article-content <?= has_post_thumbnail() ? 'col-md-10' : 'col-12'; ?>">
                        ...
                        <? if (get_field('article-video')){ ?>
                            <div class="article-video video-responsive">
                                <iframe src="<?= youtubeLinkTransform(get_field('article-video')); ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        <? } ?>
                    </div>
